...
# server {
  ...
  # Fichier de log
  access_log /var/log/nginx/ssl.glpi.access.log;
  error_log /var/log/nginx/ssl.glpi.error.log;
  ...
  # Répertoire dans lequel est installé GLPI
 ...
 #interdire laccès aux sous dossiers de glpi.
